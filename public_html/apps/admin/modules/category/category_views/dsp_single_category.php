...
$sel_type = isset($arr_single_category['C_TYPE']) ? $arr_single_category['C_TYPE'] : '';
    ...
    <div class="Row">
        ...
        <div class="right-Col">
            <select  name="sel_type" id="sel_type" >
                <option value="news" <?php echo ($sel_type == 'news') ? 'selected' : ''; ?> >Tin tức</option>
                <option value="notification" <?php echo ($sel_type == 'notification') ? 'selected' : ''; ?> >Thông báo</option>

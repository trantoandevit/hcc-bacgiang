...
?>
<h1 class="page-header"><?php echo __('Danh sách lĩnh vực thống kê'); ?></h1>
<form action="<?php $this->get_controller_url();?>" name="frmMain" id="frmMain" method="POST">
            ...
            <div class="table-responsive">
                <table class="adminlist">
                    ...
                    <tr>
                        ...
                        <th><?php echo __('Tên lĩnh vực thống kê'); ?></th>
                    ...
                    <tbody>
                        <?php $row = 0; ?>
                        <?php foreach ($arr_all_linh_vuc_thong_ke as $arr_row): ?>
                            <tr>
                                <td class="Center">
                                    <input type="checkbox" name="chk"
                                           value="<?php echo $arr_row['PK_LINH_VUC_VAN_BAN']; ?>" 
                                ...
                                <td style="text-align:center" align="center">
                                        <a href="javascript:void(0)" onclick="row_onclick(<?php echo $arr_row['PK_LINH_VUC_VAN_BAN']; ?>)">  
    ...
    <?php //echo $this->paging2($arr_all_linh_vuc_thong_ke); ?>

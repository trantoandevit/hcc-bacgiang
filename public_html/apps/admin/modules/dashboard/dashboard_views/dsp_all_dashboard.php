                ...
                <div id="dashboard_content">
                    <table id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu" class="TableLeftMenuOverview" cellspacing="0" align="Left" border="0" style="border-width:0px;width:180px;border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <?php endif; ?>
                            <?php if (session::check_permission('QL_CO_QUAN_BAN_HANH') > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                                        <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                                            <img alt="" onclick="javascript:window.location='<?php echo $this->get_controller_url('co_quan_ban_hanh'); ?>'" id="imgSubRole" style="cursor:pointer;" width="99" height="84" src="<?php echo SITE_ROOT . "public/images/coquanbanhanh.png" ?>">
                                        </div>
                                        <div class="Item">
                                            <a href="<?php echo $this->get_controller_url('co_quan_ban_hanh'); ?>">
                            ...
                            <?php endif; ?>
                            <?php if (session::check_permission('QL_LINH_VUC_THONG_KE') > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                                        <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                                            <img alt="" onclick="javascript:window.location='<?php echo $this->get_controller_url('linh_vuc_thong_ke'); ?>'" id="imgSubRole" style="cursor:pointer;" width="99" height="84" src="<?php echo SITE_ROOT . "public/images/linh_vuc_thong_ke.png" ?>">
                                        </div>
                                        <div class="Item">
                                            <a href="<?php echo $this->get_controller_url('linh_vuc_thong_ke'); ?>">
                                                <span>Lĩnh vực thống kê</span>
                                            </a>
                                        </div>
                                    </div>
                                </td>
                            <?php endif; ?>
                            <?php if (session::check_permission('QL_VAN_BAN') > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                                        <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                                            <img alt="" onclick="javascript:window.location='<?php echo $this->get_controller_url('van_ban'); ?>'" id="imgSubRole" style="cursor:pointer;" width="99" height="84" src="<?php echo SITE_ROOT . "public/images/van_ban.png" ?>">
                                        </div>
                                        <div class="Item">
                                            <a href="<?php echo $this->get_controller_url('van_ban'); ?>">
                                                <span>Văn bản</span>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div id="dashboard_system">
                    <table id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu" class="TableLeftMenuOverview" cellspacing="0" align="Left" border="0" style="border-width:0px;width:180px;border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <?php  endif; ?>
                            <?php if (session::check_permission('QUYEN_ADMIN') > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                                        <img alt="" onclick="javascript:window.location='<?php echo $this->get_controller_url('synchronize'); ?>'" id="imgSubRole" style="cursor:pointer;" width="99" height="84" src="<?php echo SITE_ROOT . "public/images/synchronize.png" ?>">
                                    </div>
                                    <div class="Item">
                                        <a href="<?php echo $this->get_controller_url('synchronize'); ?>">
                                            <span><?php echo __('Đồng bộ dữ liệu'); ?></span>
                                        </a>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                                        <img alt="" onclick="javascript:window.location='<?php echo $this->get_controller_url('danh_sach_can_bo'); ?>'" id="imgSubRole" style="cursor:pointer;" width="99" height="84" src="<?php echo SITE_ROOT . "public/images/personnel.jpg" ?>">
                                    </div>
                                    <div class="Item">
                                        <a href="<?php echo $this->get_controller_url('danh_sach_can_bo'); ?>">
                                            <span><?php echo __('Danh sách cán bộ'); ?></span>
                                        </a>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                                        <img alt="" onclick="javascript:window.location='<?php echo $this->get_controller_url('spec'); ?>'" id="imgSubRole" style="cursor:pointer;" width="99" height="84" src="<?php echo SITE_ROOT . "public/images/spec.png" ?>">
                                    </div>
                                    <div class="Item">
                                        <a href="<?php echo $this->get_controller_url('spec'); ?>">
                                            <span><?php echo __('Quản lý lĩnh vực'); ?></span>
                                        </a>
                                    </div>
                                </div>
                            </td>

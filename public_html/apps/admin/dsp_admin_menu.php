...
<div id="menu_content">
    <table id="ctl00_ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu" class="TableLeftMenu" cellspacing="0" align="Left" border="0" style="border-width:0px;width: 100%;border-collapse:collapse;">
        ...
        <?php endif; ?>
            <?php if (session::check_permission('QL_CO_QUAN_BAN_HANH', 0) > 0): ?>
            <tr>
                <td class="LeftMenu" data-name="co_quan_ban_hanh">
                    <div class="Content_menu">
                        <div class="Item">
                            <a href="<?php echo get_admin_controller_url('co_quan_ban_hanh'); ?>">
        ...
        <?php endif; ?>
        <?php if (session::check_permission('QL_LINH_VUC_THONG_KE', 0) > 0): ?>
            <tr>
                <td class="LeftMenu" data-name="linh_vuc_thong_ke">
                    <div class="Content_menu">
                        <div class="Item">
                            <a href="<?php echo get_admin_controller_url('linh_vuc_thong_ke'); ?>">
        ...
        <?php endif; ?>
        <?php if (session::check_permission('QL_VAN_BAN', 0) > 0): ?>
            <tr>
                <td class="LeftMenu" data-name="van_ban">
                    <div class="Content_menu">
                        <div class="Item">
                            <a href="<?php echo get_admin_controller_url('van_ban'); ?>">
                                <span>Văn bản</span>
                            </a>
                        </div>
                    </div>
...
<div id="menu_system">
    <table name="tbl_menu_system" id="tbl_menu_system" class="TableLeftMenu" cellspacing="0" align="Left" border="0" style="border-width:0px;width: 100%;border-collapse:collapse;">
        ...
        <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if(session::check_permission('QUYEN_ADMIN',FALSE)):; ?>
            <tr>
                <td class="LeftMenu" data-name="synchronize">
                    <div class="Content_menu">
                        <div class="Item">
                            <a href="<?php echo get_admin_controller_url('synchronize'); ?>">

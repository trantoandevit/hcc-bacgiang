(function(){
    ...
    $(document).ready(function(){
        ...
        function show_item(data, count_item){
            ...
            var link = sv.url.build_notification(filter.cat_slug, art_slug, filter.website_id, filter.cat_id, art_id);
        ...
        function show_first_row(data){
            ...
            if(data_first_row.count == 2)
            {
                ...
                var link_1 = sv.url.build_notification(filter.cat_slug, art_slug_1, filter.website_id, filter.cat_id, art_id_1);
                ...
                var link_2 = sv.url.build_notification(filter.cat_slug, art_slug_2, filter.website_id, filter.cat_id, art_id_2);

    ...
    $(document).ready(function () {
        ...
        sv.data.synthesis_month('','','',function(respone){
            ...
            for(var index in respone)
            {
                ...
                html += '<td><a href="'+FULL_SITE_ROOT+'tra-cuu-tong-hop?member='+respone[index].C_UNIT_CODE+'">'+ count +'. '+ unit_name +'</a></td>';
                ...
                $('#' + id_table_synthesis + ' tbody').append(html);
        ...
        $('.month-block').height($('.statistic-block').outerHeight());

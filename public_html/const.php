...
define('_CONST_DEFAULT_ROWS_PER_PAGE', 20);
...
define('_CONST_LIMIT_NEW_DOCUMENT',10);// Limit so van ban hien thi
define('_CONST_LIMIT_HOME_DOCUMENT',10);

define('_CONST_DEFAULT_EMPLOYMENT_PER_PAGE', 10);
...
//const service 
define('_CONST_DEVELOPER_SAVISS_CODE','saviss');
define('_CONST_DEVELOPER_TAM_VIET_CODE','tam_viet');


define('_CONST_API_SERVICE_GET_ALL_MEMBER', FULL_SITE_ROOT . 'admin/api_service/get_all_member');
define('_CONST_API_SERVICE_GET_SYNTHESIS', FULL_SITE_ROOT . 'admin/api_service/get_synthesis');
define('_CONST_API_SERVICE_GET_RECORD_INFO', FULL_SITE_ROOT . 'admin/api_service/get_record_info');
define('_CONST_API_SERVICE_GET_GET_SPEC', FULL_SITE_ROOT . 'admin/api_service/get_spec');
define('_CONST_API_SERVICE_GET_RECORD_TYPE', FULL_SITE_ROOT . 'admin/api_service/get_record_type_by_member_and_spec');
define('_CONST_API_SERVICE_GET_LOOKUP_RECORD', FULL_SITE_ROOT . 'admin/api_service/get_lookup_record');

//default const for api service
define('_CONST_DEFAULT_SPEC_LEVEL_OF_DISTRICT', 'CAP_HUYEN');

// captcha key
define('_CONST_CLIENT_CAPTCHA_PUBLIC_KEY', '6LcPjB4TAAAAAC1XT-Jg69S70RNxNOHXlOZXc1ZP');
define('_CONST_SERVER_CAPTCHA_PRIVATE_KEY', '6LcPjB4TAAAAAFTsfnRgg7_JfedYG7p0cTBH0bQJ');
